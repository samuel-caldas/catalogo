...
pWidth=myPageW+(pageBorderWidth); 
pHeight=myPageH+(pageBorderWidth); 

myBook=document.getElementById("myBook");
myBook.style.width=(pWidth*2)+'px';
myBook.style.marginLeft='-'+pWidth+'px';
myBook.style.left='50%';
...
function doAutoFlip(num,dir){
	...
	num--;
	AF = window.setTimeout('doAutoFlip('+num+','+dir+')',50);
}
